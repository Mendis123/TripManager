package com.bignerdranch.android.tripmanagerapp;
...
public class SQLiteDB extends SQLiteOpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            db.execSQL("DROP TABLE IF EXISTS ACTIVITY_LOG" + ACTIVITY_LOG_TABLE);
            db.execSQL("DROP TABLE IF EXISTS USER_PROFILE" + PROFILE);
            onCreate(db);
        }
